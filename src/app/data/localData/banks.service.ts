...
export class BanksService {
  ...
  constructor(
    ...
    for (let bank of this.banks) {
      bank['image'] = `assets/images/banks/${bank['slug']}.png`;
    }
  }
  ...
  getAccName({ bank_code, account_number }) {
    return this.http.get<any>(
      `${this.baseUrl}user/account-settings/verify-account-number/${account_number}/${bank_code}`
    )
  }
}
