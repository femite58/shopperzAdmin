    ...
    blogs = [
        {
            ...
            banner: 'https://res.cloudinary.com/bluescrow/image/upload/v1663361220/assets/blog/post-1-large_cacuvd.png',
            thumbnail:
        ...
        },
        {
            ...
            banner: 'https://res.cloudinary.com/bluescrow/image/upload/v1663361220/assets/blog/Post-2-large_xht0lr.png',
            thumbnail:
        ...
        },
        {
            ...
            content: `<p>After several months of putting in the hard works, testing and general overhauling to ensure users have the best experience using our platform we are excited to announce that its time! Yes I mean it is time to go live and Monday 3rd October, 2022 is the date.</p>
                ...
                <p>Start sharing…!!</p>`,
            banner: 'https://res.cloudinary.com/bluescrow/image/upload/v1663361219/assets/blog/Post-3-large_on5gvy.png',
            thumbnail:
