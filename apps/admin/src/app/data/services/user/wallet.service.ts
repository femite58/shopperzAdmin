...
export class WalletService {
  ...
  withdraw(data) {
    return this.http.post<any>(`${this.baseUrl}user/withdrawal/request`, data);
  }

  deleteCard(id) {
    return this.http.delete<any>(`${this.baseUrl}user/all-cards/delete/${id}`);
  }

  validateOtp(data) {
    return this.http.post<any>(`${this.baseUrl}user/wallet/validateotp`, data);
  }
