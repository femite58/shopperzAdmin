...
export class AuthService {
  ...
  twoFactorSet(data) {
    return this.http
      .post<any>(`${this.baseUrl}user/account-settings/set-two-factor`, data)
      .pipe(
        tap((res) => {
          this.storeAuth(res.data);
        })
  ...
  forgotPassResendCode(data) {
    return this.http.post<any>(`${this.baseUrl}forgot-password/resend`, data);
  }
  ...
  verifyEmail(data) {
    return this.http
      .post<any>(`${this.baseUrl}user/account-settings/email-verify`, data)
      .pipe(
        tap((res) => {
          this.storeAuth(res.data);
        })
