  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  ngAfterViewInit() {
    setTimeout(() => {
      if (isPlatformBrowser(this.platformId)) {
        ...
        this.prev =
          this.carouselParent.nativeElement.querySelector('.carouselCtrlPrev');
        this.next =
          this.carouselParent.nativeElement.querySelector('.carouselCtrlNext');
  ...
  private initiateCarousel() {
    ...
    this.indicatorSelect(null, this.initActInd);
  }
